    ...
    <section class="sidebar">
        <ul class="sidebar-menu">
            ...
            <li class="treeview @if(Request::is('dealer/objects/*'))    {{"active"}} @endif ">
                <a href="#"><i class="fa fa-female"></i> <span>Vehicles Management</span> <i class="fa fa-angle-left pull-right"></i></a>

                <ul class="treeview-menu" style="@if( Request::is('dealer/objects/*')) {{"display:block"}} @else {{"display:none"}} @endif">

                    <li @if(Request::is('dealer/objects/noauction')) {{"class=active"}} @endif ><a href="{{url('dealer/objects/noauction')}}"><i class="fa fa-circle-o"></i><span>New Vehicles</span></a></li>
                    <li @if(Request::is('dealer/objects/auction')) {{"class=active"}} @endif ><a href="{{url('dealer/objects/auction')}}"><i class="fa fa-circle-o"></i><span>Vehicles Under Auctions</span></a></li>
                </ul>
            </li>
