    ...
    <div class="box box-success">
        <div class="x_panel">
            <div class="box-header">
                ...
                <div class="clearfix"></div>
                <!--a href="{{url('dealer/objects/create')}}" class="btn btn-info btn-sm pull-right">ADD NEW INSPECTOR</a-->
            </div>
            <div class="x_content">
                @if(session('success'))
                    ...
                    <div class="box-body">
                        <div class="row">
                            <div class="form-group col-md-6">
                               <label class="control-label col-sm-3" for="start_time">Vehicle Name</label>
