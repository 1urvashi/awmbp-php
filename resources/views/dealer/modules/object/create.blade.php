    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="box box-primary">
                ...
                <form role="form" enctype="multipart/form-data" method="post" action="@if(isset($edit)){{url('dealer/objects/'.$edit->id)}}@else{{url('dealer/objects')}}@endif">
                       ...
                       <div class="col-xs-12">
                            <div class="col-xs-6 item">
                                <div class="form-group">
                                    ...
                                    <input type="file" data-max-size="32154"  multiple class="form-control" id="images" name="images[]" required accept="image/jpeg,image/gif,image/png,image/jpg">
                               </div>
                            ...
                            <div class="col-xs-6 item">
                                <div class="form-group">
                                    ...
                                    <input type="file" data-max-size="32154"  multiple class="form-control" id="attachment" name="attachment[]"  accept="image/jpeg,image/gif,image/png,image/jpg">
                               </div>
