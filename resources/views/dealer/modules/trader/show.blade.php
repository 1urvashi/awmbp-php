...
<div class="clearfix"></div>
    <div class="col-md-12 box box-success">
        ...
        <div class="container">    
            <div class="row">
                <div class="col-md-4">
                    <img id="mob_display" style="max-width: 300px;" src="{{$trader->image}}"/>
                </div>  
                <div class="col-md-8">
                    <div class="pull-right">
                        <h2>
                            ...
                            <a href="{{url('dealer/traders/credits/'.$trader->id)}}"><i class="fa fa-eye"></i></a>
                        </h2>
                    </div>
                    <div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="col-md-4">
                        <h3>Passport</h3>
                        <img class="img-responsive img-thumbnail"  src="{{$trader->passport}}"/>
                    </div>
                    <div class="col-md-4">
                        <h3>Trade License</h3>
                        <img class="img-responsive img-thumbnail"  src="{{$trader->trade_license}}"/>
                    </div>
                    <div class="col-md-4">
                        <h3>Document</h3>
                        <img class="img-responsive img-thumbnail" src="{{$trader->document}}"/>
                    </div>
                </div>
            </div>
            <div class="row">
