                            ...
                            <div class="form-control file-img">
                             ...
                             <div class="col-xs-12">
                                ...
                                <li>
                                    ...
                                    data-darkbox="{{$image->image}}" alt="Vehicle Image" class="img-eid">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label>Business Size (No of Vehicles) <span class="req">*</span></label>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group icheck-custom">
                                        <label>Age of Vehicle <span class="req">*</span></label>
                                        <!-- checkbox -->
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group icheck-custom">
                                        <label>Vehicle condition <span class="req">*</span></label>
                                        <!-- checkbox -->
                            ...
                            <div class="row">
                              <div class="col-md-4">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group icheck-custom">
                                        <label>Make of Vehicle <span class="req">*</span></label>
                                        <!-- checkbox -->
