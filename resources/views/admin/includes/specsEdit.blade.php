                ...
                <div class="col-md-12 oreder">
                    ...
                    <div class="col-xs-6 item">
                        <div class="form-group">
                            ...
                            <input type="file" multiple class="form-control" id="images" name="images[]" data-max-size="32154"  accept="image/jpeg,image/gif,image/png,image/jpg,image/jpg">
                        </div>
                ...
                <div class="col-md-12 document">
                    <div class="col-xs-12 item">
                        <div class="form-group">
                            ...
                            <input type="file" multiple class="form-control" id="attachment" name="attachment[]" data-max-size="32154"  accept="image/jpeg,image/jpg,image/gif,image/png,image/jpg">
                        </div>
