...
<header class="header">
    <div class="container">
        <nav id="main-nav" class="navigation">
            <a class="navigation__logo" href="{{url(session()->get('language').'/')}}"><img class="navigation__logo" src="{{url('css/frontend/assets/img/logo-black.svg')}}" alt="vehicle my bid logo"></a>
