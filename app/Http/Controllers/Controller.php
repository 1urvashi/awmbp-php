...
class Controller extends BaseController {
    ...
    // public $bcc = ['faz@wecashanycar.com', 'faiyazchand@hotmail.com'];
    ...
    public function sendAutomaticPush($auctionId, $price) {
        ...
        if (!empty($usersInRange)) {
            ...
            foreach ($usersInRange as $userInRange) {
                ...
                // dd($trader->device_type,$trader->device_id,$trader->device_type == 'iOS');

                if (!empty($trader->device_type)) {
        ...
        return true;
         try {
              ...
              if ($type == 1) {
                   ...
                   $msg = 'Your vehicle ' . $auction->title . ' has failed Quality Control';
              } elseif ($type == 4) {
                   // return true;
                   $msg = 'Your vehicle ' . $auction->title . ' has sold susessfully';
              } elseif ($type == 5) {
