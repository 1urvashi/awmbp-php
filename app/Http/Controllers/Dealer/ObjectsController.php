...
class ObjectsController extends Controller
{
    ...
    public function noData(Request $request)
    {
        ...
        return Datatables::of($objects)
                ->addColumn('action', function ($objects) {
                   ...
                   .'<a href="../object/edit/'.$objects->id.'" class="btn btn-xs btn-success"><i class="fa fa-pencil-square-o"></i>Edit Vehicle</a>';
                    return $txt;
                })
                ->editColumn('created_at', function($objects) {
                     return date('Y-m-d h:i:s A', strtotime($this->UaeDate($objects->created_at)));
 ...
 // dd($images);
         ...
         return redirect('dealer/objects/noauction')->with('success', 'Successfully added new vehicle');
